...
static mxArray * MB_set_LPsol_MatrixPtr(const dd_LPPtr lp)
{
  mxArray * P;	
  mxArray * tmpx;
  mxArray * tmpy;	
...
static dd_MatrixPtr FT_get_H_MatrixPtr(const mxArray * in)
{
  mxArray * tmpa;	
  mxArray * tmpb;	
  mxArray * tmpl;	
...
static dd_LPPtr MB_get_LP_MatrixPtr(const mxArray * in)
{
  mxArray * tmpobj;
  dd_MatrixPtr A;
  int j;
...
static mxArray * FT_set_V_MatrixPtr(const dd_MatrixPtr M)
{
  mxArray * P;
  int mr, mv, m, i, j;
  int ir, iv;
...
static dd_MatrixPtr FT_get_V_MatrixPtr(const mxArray * in)
{
  mxArray * tmpv;	
  mxArray * tmpr;	
  dd_MatrixPtr V;
...
static mxArray * FT_set_SetFamilyPtr(const dd_SetFamilyPtr F)
{
  mxArray * A, * tmp;
  double * r;
  int i, j, k;
...
static mxArray * FT_set_Set(const set_type S)
{
  mxArray * tmp;
  double * r;
  int i, j;
...
static mxArray * FT_set_H_MatrixPtr(const dd_MatrixPtr M)
{
  mxArray * P;	
  mxArray * tmpa;	
  mxArray * tmpb;	
...
static void hull(int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[])
{
  dd_PolyhedraPtr P;
  dd_ErrorType err;
  dd_MatrixPtr H,V;
